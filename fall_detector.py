...
class Fall_detector:
    ...
    def preproc(self, image):
        ...
        """
        resize_fn = ResizePadding(self.args.detection_input_size, self.args.detection_input_size)
    ...
    def load_models(self):
        # DETECTION MODEL.
        self.detect_model = TinyYOLOv3_onecls(self.args.detection_input_size, device=self.args.device)

        # POSE MODEL.
        inp_pose = self.args.pose_input_size.split('x')
        inp_pose = (int(inp_pose[0]), int(inp_pose[1]))
        self.pose_model = SPPE_FastPose(self.args.pose_backbone, inp_pose[0], inp_pose[1], device=self.args.device)
